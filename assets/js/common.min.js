function fullPage() {
    $("#js-fullpage").fullpage({
        ...
        scrollingSpeed: 1e3, anchors: ["top", "about", "projects", "contact"],
        navigation: !0, navigationPosition: "left",
        animateAnchor: !1, onLeave: function (index, nextIndex, direction) {
            ...
            if (0 == state) {
                ...
                anime.timeline().add({
                    ...
                    translateZ: 0,
                    easing: "easeInOutCubic",
                    duration: 800, delay: function (el,
                        i) { return 50 * i },
                    offset: "-=1500"
                });
                if (1 == index) anime({
        ...
        afterRender: function () {
            $(".section").each(function (i) {
                var num = i + 1; $(this).addClass("fp-section-" + num)
            })
        }
    })
}
...
}); topTransition.init(); var underLayer = Barba.BaseView.extend({
    namespace: "underlayer", onEnter: function () {
        Barba.Pjax.getTransition = function () {
...
}); underLayer.init(); var PageTransitionTop = Barba.BaseTransition.extend({
    start: function () {
    ...
    start: function () {
        ...
        return new Promise(function (resolve) {
            anime({
                ...
                translateZ: 0,
                duration: 800,
                easing: "easeInOutCubic", complete: function () {
                    $(".menuIcon").removeClass("js-menuOpen"),
                        $(".global-nav").removeClass("js-open"),
    ...
    start: function () {
        ...
        return new Promise(function (resolve) {
            var closeAnime = anime.timeline({
                duration: 500, easing: "easeInOutCubic", autoplay: !1, complete: function () {
                    resolve()
                }
            }).add({
